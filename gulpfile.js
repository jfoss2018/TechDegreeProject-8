// As a developer, I should be able to run the npm install command to install
// all of the dependencies for the build process.
...
// As a developer, I should be able to run the gulp styles command at the
// command line to compile the project’s SCSS files into CSS, then concatenate
// and minify into an all.min.css file that is then copied to the dist/styles
// folder.
...
// As a developer, I should be able to run the gulp clean command at the command
// line to delete all of the files and folders in the dist folder.
...
// Extra Credit: As a developer, when I run the default gulp command, it should
// continuously watch for changes to any .scss file in my project. When there is
// a change to one of the .scss files, the gulp styles command is run and the
// files are compiled, concatenated, and minified to the dist folder. My project
